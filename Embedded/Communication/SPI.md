...
<img src="../../pic/Embedded/Communication/spi_signal_line.png" style="width:600px;padding:10px;"/>
...
<img src="../../pic/Embedded/Communication/spi_communication.png" style="width:600px;padding:10px;"/>
...
<img src="../../pic/Embedded/Communication/spi_00.png" style="width:600px;padding:10px;"/>

### CPOL = 0, CPHA = 1
空闲时 SCLK 为低电平，每个周期的第二个时钟沿采样。LSB* 表示下一帧的 LSB\
<img src="../../pic/Embedded/Communication/spi_01.png" style="width:600px;padding:10px;"/>

### CPOL = 1, CPHA = 0
空闲时 SCLK 为高电平，每个周期的第一个时钟沿采样。\
<img src="../../pic/Embedded/Communication/spi_10.png" style="width:600px;padding:10px;"/>

### CPOL = 1, CPHA = 1
空闲时 SCLK 为高电平，每个周期的第二个时钟沿采样。\
<img src="../../pic/Embedded/Communication/spi_11.png" style="width:600px;padding:10px;"/>
