...
3. 奇异值
<img src="../../../pic/Subject/Linear Algebra/Algorithm/svd-sum-matrix.png" style="width:600px;padding:10px;"/>

4. 第二种求奇异值方式\
特征值矩阵等于奇异值矩阵的平方，通过求出 ${A}^{T}A$ 的特征值取平方根来求奇异值
## 实例
<img src="../../../pic/Subject/Linear Algebra/Algorithm/svd-example.png" style="width:600px;padding:10px;"/>