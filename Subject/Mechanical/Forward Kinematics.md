...
### D-H 参数
<img src="../../pic/Subject/Mechanical/classic_dh.png" style="width:600px;padding:10px;"/>
...
<img src="../../pic/Subject/Mechanical/classic_dh_z.png" style="width:600px;padding:10px;"/>

4. X 轴：\
（1）若两 Z 轴不平行不相交，则沿两 Z 轴的公垂线方向为 X 轴正方向\
（2）若两 Z 轴平行，则按任一公垂线为 X 轴\
（3）若两 Z 轴相交，则按两轴的叉积方向为 X 轴\
<img src="../../pic/Subject/Mechanical/classic_dh_x.png" style="width:600px;padding:10px;"/>
