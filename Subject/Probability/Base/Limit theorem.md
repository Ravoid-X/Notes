...
<img src="../../../pic/Subject/Probability/Base/limit-markov.png" style="width:300px;padding:10px;"/>\
可知$I_{X≥a}(X)≤\frac x a$，对该式取数学期望得马尔可夫不等式\
$I_{X≥a}=P(X≥a)≤\frac {E(X)} a$

### 切比雪夫不等式
于随机变量 $X$，记 $\mu=E(X)$，考虑随机事件 $A=\{|X-\mu|≥a\}$，其示性函数如下所示\
<img src="../../../pic/Subject/Probability/Base/limit-chebyshev.png" style="width:300px;padding:10px;"/>\
